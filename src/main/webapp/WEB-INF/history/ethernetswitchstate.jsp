        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
            	<div class="container-fluid">
					<h3 class="dash-title">이더넷 스위치 상태</h3>
                      ...
                      <div class="card easion-card">
                       ...
                       <div class="card easion-card">
                          <div class="card-body " >
                          	<h5 style="text-align: center;">백본(BACKUP)</h5>
                          	<div class="mt-3">
                          		...
                          		<c:forEach var="list"    begin="1" end="22" step="1" varStatus="status">
						 			<div class="portDiv">
						 				<c:choose>
                                       	...
                                       	<div><label for="" style="">액세스#${status.index} 1</label></div>
                                    </div>
					  			</c:forEach>
